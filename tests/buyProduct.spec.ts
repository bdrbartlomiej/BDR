...
test('kupienie produktu przez nowego uzytkownika', async ({ page }) => {
  ...
  await page.locator('css=#order_bill_address_attributes_firstname').fill('Bartek');
  await page.locator('css=#order_bill_address_attributes_lastname').fill('Testus');
  ...
  await page.locator('css=#order_bill_address_attributes_phone').fill('500000000');
